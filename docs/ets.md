...
```elixir
use LiveStash, adapter: LiveStash.Adapters.ETS, ttl: 60 * 1000, stored_keys: [:count]
```
...
```elixir
use LiveStash, adapter: LiveStash.Adapters.ETS, session_key: "user_token", stored_keys: [:count]
```
