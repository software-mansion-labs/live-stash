defmodule ShowcaseAppWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ShowcaseAppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ShowcaseAppWeb.Gettext, "errors", msg, opts)
    end
  end
  ...
  def socket_debugger(assigns) do
    ...
    <button
      type="button"
      title="Symuluje zerwanie połączenia z serwerem"
      onclick="
