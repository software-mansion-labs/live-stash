defmodule TestingWeb.Performance.LiveStashMnesiaLive do
  use TestingWeb, :live_view

  use TestingWeb.Performance.LiveStash,
  ...
  def render(assigns) do
    ~H"""
    <div
      id="performance-livestash-mnesia"
    ...
    >
      <h1>Performance (LiveStash Mnesia)</h1>
      <p>size_kb: {@size_kb}</p>
